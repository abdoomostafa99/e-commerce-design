...
ALTER TABLE orders
	ADD CONSTRAINT FK_1  FOREIGN KEY (customerID) REFERENCES customers(customerID) ;
    
ALTER TABLE orders
	ADD CONSTRAINT FK_2  FOREIGN KEY (shipperID) REFERENCES shippers(shipperID) ;
    
ALTER TABLE orders
	ADD CONSTRAINT FK_3  FOREIGN KEY (employeeID) REFERENCES employees(employeeID) ;
    
ALTER TABLE order_details
	ADD CONSTRAINT FK_4  FOREIGN KEY (orderID) REFERENCES orders(orderID) ;
    
ALTER TABLE order_details
	ADD CONSTRAINT FK_5  FOREIGN KEY (productID) REFERENCES products(productID) ;
    
ALTER TABLE products
	ADD CONSTRAINT FK_6  FOREIGN KEY (supplierID) REFERENCES suppliers(supplierID) ;
    
ALTER TABLE products
	ADD CONSTRAINT FK_7  FOREIGN KEY (categoryID) REFERENCES categories(categoryID) ;